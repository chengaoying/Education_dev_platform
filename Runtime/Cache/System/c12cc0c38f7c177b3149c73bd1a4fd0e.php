...
<div data-options="region:'center',split:true,border:false" style="overflow: hidden;">
	...
	ID：<input type="text" name="id" placeholder="ID" style="width: 50px"></input>
...
function add(){
	addData("添加","#edit_form",datagrid,"/System/ChargeMode/add",edit_W,edit_H);
}
function edit(rowIndex,rowData){
	editData(rowIndex,rowData,"编辑",'#edit_form',datagrid,"/System/ChargeMode/edit",edit_W,edit_H);
}
function del(){
	delData(datagrid,"/System/ChargeMode/del");
}
