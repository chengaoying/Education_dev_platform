...
function add(){
	addData("添加","#edit_form",datagrid,"/System/Credit/add",edit_W,edit_H);
}
function edit(rowIndex,rowData){
	editData(rowIndex,rowData,"编辑",'#edit_form',datagrid,"/System/Credit/edit",edit_W,edit_H);
}
function del(){
	delData(datagrid,"/System/Credit/del");
}
