...
<table class="editTable">
	...
	<tr><th>题库导航图片</th><td><input type="text" id="imgUrl" name="imgUrl" value="<?php echo ($res['imgUrl']); ?>" style="width:250px" /><a href="#" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="upfileDialog('<?php echo ($currProduct['id']); ?>',1,'','资源图片：<?php echo ($res[title]); ?>',0,0,'#imgUrl')"></a></td></tr>	
