...
<table class="editTable">
	...
	<tr><th>视频流code：</th><td><textarea name="content" id="content" cols="50" rows="5"><?php echo ($res['content']); ?></textarea><a href="#" id="upContent" style="display:none;" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="upfileDialog('<?php echo ($currProduct['id']); ?>',1,'','资源图集图片：<?php echo ($res[title]); ?>',1,1,'#content','\r\n')"></a><br>注：海南地区有多个值，换行符(回车键)分隔，第一行中兴平台code，第二行华为平台code（带有rtsp的播放地址）。</td></tr>
	...
	<tr><th>资源导航图片</th><td><input type="text" id="imgUrl" name="imgUrl" value="<?php echo ($res['imgUrl']); ?>" style="width:250px" /><a href="#" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="upfileDialog('<?php echo ($currProduct['id']); ?>',1,'','资源图片：<?php echo ($res[title]); ?>',0,0,'#imgUrl')"></a></td></tr>	
