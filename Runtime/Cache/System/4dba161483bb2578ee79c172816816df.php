...
$(function(){
	...
	datagrid = $("#datagrid").datagrid({
	    ...
	    columns:[[ 
            ...
            {field:'name',title:'栏目名称',sortable:false,width:200,formatter:function(value,row,index){return (new Array(parseInt(row.level)+1).join("　　")) + value;}},
			...
			{field:'isShow',title:'在首页导航中',sortable:true,width:100,formatter:function(value,row,index){return value==1 ? "显示" : "<font color=red>不显示</font>";}},                      
